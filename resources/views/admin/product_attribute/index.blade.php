...
@section('title', 'Product Attribute Summary |')

@section('breadcrumb')
<li class="breadcrumb-item active">Product Attribute Summary</li>
@endsection
...
@include('flash-message')
    <div class="card">
        <div class="card-header">
           <div class="row">
                <div class="col-md-10">
                  <h4 class="m-0">{{__("Product Attribute Summary")}}</h4>
                </div>
                <div class="col-md-2" >
                    <a href="{{url('admin/attributes/create')}}" class="btn-dark btn-sm card-btn-right">{{__("Add Product Attribute")}}</a>
                </div>
            </div>
        </div>  
        <div class="card-body">
            <div class="alert alert-info">
                <strong>Info!</strong> Product attribute once created cannot be deleted.
            </div>
            <table id="product_attribute_table" class="table table-bordered table-striped ">
                <thead>
                ...
                <tbody>
                    @foreach($attr as $ind => $a)
                        <tr>
                            ...
                            <td>{{$a->attr_value}}</td>
                            <td>
                                <a href="{{url('/admin/attributes/'.$a->id.'/edit')}}" class="btn btn-xs btn-info"><i class="fa fa-pen"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
