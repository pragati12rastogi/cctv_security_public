...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/return-policy/'.$policy->id)}}" data-parsley-validate class="form-horizontal form-label-left">
            {{csrf_field()}}
            {{method_field("PUT")}}
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input placeholder="Enter Policy Name" type="text" id="name" name="name" value="{{$policy->name}}" class="form-control">
                    </div>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12 ">
                        <input placeholder="15" type="text" id="days" name="days" value="{{$policy->days}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <textarea rows="5" cols="10"  type="text" name="description"  class="form-control ckeditor">{{$policy->description}}</textarea>
                        @error('description')
                        <span class="invalid-feedback d-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-xs-12 ">
                    <hr>
                    <button type="submit" class="btn btn-dark mt-3">Update Policy</button>
                </div>
            </form>
        </div>
    </div>
