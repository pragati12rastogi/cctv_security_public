...
<head>
	<meta charset="UTF-8">
    <title>Print Invoice: {{ $order->order_id }}</title>
...
<body>
    <div class="container-fluid">
		<h3 class="text-center">Invoice: {{ $order->order_id }}</h3>
		<div class="row justify-content-md-center">
			<div class="printheader padding-15">
				<br>
                <div id="hide-div">
                    <a href="{{ route('all.orders.edit',$order->id) }}" title="Go back" class="p_btn2 pull-left btn btn-md btn-default"><i class="fa fa-reply" aria-hidden="true"></i></a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
								...
								<br>
								<b>Date:</b> {{ date('d-m-Y',strtotime($order->created_at)) }}
							</td>
                        </tr>
                        <tr>
							<th>
                ...
                <table class="table table-bordered">
					...
					<tbody>
                        @foreach($order->invoices as $o_ind => $invoice)
						<tr>
                            <td>
                        ...
                        <tr>
							...
							<td>
                            <i class="fa fa-rupee-sign"></i>
                            {{ round($order->order_total + $order->shipping_total,2) }}
							</td>
						</tr>
                    </tbody>
                </table>
