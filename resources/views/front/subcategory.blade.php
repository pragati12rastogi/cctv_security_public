        ...
        <div class="container">
            <div class="aa-catg-head-banner-content">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{url('/user/category/'.$cat_id)}}">{{$subcat['category']['name']}}</a></li>
                ...
                <div class="aa-product-catg-content ">
                    <div class="aa-product-catg-head">
                        <div class="aa-product-catg-head-left">
                            <form action="{{url('user/subcategory/'.$subcat['id'])}}" class="aa-sort-form" method="POST">
                                @csrf
                            ...
                            @if(!empty($filters_req))
                                <form action="{{url('user/subcategory/'.$subcat['id'])}}" class="" method="GET">
